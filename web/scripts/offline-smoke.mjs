...
assert.deepEqual(new Set(state.catalog.filter(part => part.kind === 'finish').map(part => part.id)), new Set(['standard', 'shimmer', 'holo', 'etched', 'starfield', 'confetti', 'glitter', 'aurora', 'spooky']))
