...
function App() {
  ...
  async function printCard() {
    ...
    try {
      const job = await api<{ id: string; discovery_name?: string }>('/prints', 'POST', { type_id: recipe.type_id, rule_ids: rules, theme_id: recipe.theme_id, finish_id: finish, border_id: recipe.border_id, back_id: recipe.back_id, hint: titleHint.trim() }, { 'Idempotency-Key': uniqueId() })
