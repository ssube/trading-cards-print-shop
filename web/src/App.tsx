...
import type { CardCopy, Listing, NpcOffer, State, User } from './types'
...
const emptyState: State = { resources: {}, library: [], catalog: [], commissions: [], npcs: [], generation_count: 0, generation_limit: 5, allowance_claimed: false }
...
function App() {
  ...
  const [adminInfo, setAdminInfo] = useState<{ users: { id: number; username: string }[]; designs: { id: string; name: string }[]; audit: { id: number; action: string; target: string; reason: string }[] } | null>(null)
